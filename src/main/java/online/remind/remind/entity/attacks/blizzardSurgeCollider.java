...
public class blizzardSurgeCollider extends ThrowableProjectile {
    ...
    public blizzardSurgeCollider(EntityType<? extends ThrowableProjectile> type, Level level){
        super(type, level);
        this.noPhysics = true;
    ...
    public blizzardSurgeCollider(Level level, LivingEntity caster, float damage){
    ...
    public void tick() {
        ...
        if (playerData != null) {
            ...
            double dmgMult = (playerData.getNumberOfAbilitiesEquipped(ModAbilities.BLIZZARD_BOOST)) * 0.5f;
