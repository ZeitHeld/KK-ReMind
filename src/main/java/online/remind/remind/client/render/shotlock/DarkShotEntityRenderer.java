package online.remind.remind.client.render.shotlock;
...
@OnlyIn(Dist.CLIENT)
public class DarkShotEntityRenderer extends EntityRenderer<BaseShotlockShotEntity> {
    private CubeModel model;

    public DarkShotEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
