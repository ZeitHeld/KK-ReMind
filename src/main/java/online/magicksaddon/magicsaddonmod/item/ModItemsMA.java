...
public class ModItemsMA{
    ...
    public static final RegistryObject<Item>
        ...
        acrisius = ITEMS.register("acrisius", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.fire, 20,KKResistanceType.ice,20,KKResistanceType.lightning,20))),
        acrisiusPlus = ITEMS.register("acrisius_plus", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.fire, 25,KKResistanceType.ice,25,KKResistanceType.lightning,25))),
        aegisChain = ITEMS.register("aegis_chain", () -> new KKArmorItem(new Item.Properties().stacksTo(1),2, ImmutableMap.of(KKResistanceType.fire, 20,KKResistanceType.ice,20,KKResistanceType.lightning,20))),
        blizzaraArmlet = ITEMS.register("blizzara_armlet", () -> new KKArmorItem(new Item.Properties().stacksTo(1),2, ImmutableMap.of(KKResistanceType.ice,20))),
        blizzagaArmlet = ITEMS.register("blizzaga_armlet", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.ice,20))),
        blizzagunArmlet = ITEMS.register("blizzagun_armlet", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.ice,25))),
        busterBand = ITEMS.register("buster_band", () -> new KKArmorItem(new Item.Properties().stacksTo(1),5, ImmutableMap.of(KKResistanceType.darkness,0))),
        championBelt = ITEMS.register("champion_belt", () -> new KKArmorItem(new Item.Properties().stacksTo(1),0, ImmutableMap.of(KKResistanceType.fire, 20,KKResistanceType.ice,20,KKResistanceType.lightning,20))),
        chaosAnklet = ITEMS.register("chaos_anklet", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.darkness, 25))),
        cosmicBelt = ITEMS.register("cosmic_belt", () -> new KKArmorItem(new Item.Properties().stacksTo(1),6, ImmutableMap.of(KKResistanceType.darkness,0))),
        cosmicChain = ITEMS.register("cosmic_chain", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.fire, 25,KKResistanceType.ice,25,KKResistanceType.lightning,25))),
        darkAnklet = ITEMS.register("dark_anklet", () -> new KKArmorItem(new Item.Properties().stacksTo(1),2, ImmutableMap.of(KKResistanceType.darkness, 20))),
        divineBandanna = ITEMS.register("divine_bandanna", () -> new KKArmorItem(new Item.Properties().stacksTo(1),2, ImmutableMap.of(KKResistanceType.darkness,0))),
        elvenBandanna = ITEMS.register("elven_bandanna", () -> new KKArmorItem(new Item.Properties().stacksTo(1),1, ImmutableMap.of(KKResistanceType.darkness,0))),
        firaBangle = ITEMS.register("fira_bangle", () -> new KKArmorItem(new Item.Properties().stacksTo(1),2, ImmutableMap.of(KKResistanceType.fire,20))),
        firagaBangle = ITEMS.register("firaga_bangle", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.fire,20))),
        firagunBangle = ITEMS.register("firagun_bangle", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.fire,25))),
        gaiaBelt = ITEMS.register("gaia_belt", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.lightning,20,KKResistanceType.darkness,20))),
        midnightAnklet = ITEMS.register("midnight_anklet", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.darkness,20))),
        shadowAnklet = ITEMS.register("shadow_anklet", () -> new KKArmorItem(new Item.Properties().stacksTo(1),2, ImmutableMap.of(KKResistanceType.darkness,20))),
        shockCharm = ITEMS.register("shock_charm", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.lightning,40))),
        shockCharmPlus = ITEMS.register("shock_charm_plus", () -> new KKArmorItem(new Item.Properties().stacksTo(1),4, ImmutableMap.of(KKResistanceType.lightning,50))),
        thundaraTrinket = ITEMS.register("thundara_trinket", () -> new KKArmorItem(new Item.Properties().stacksTo(1),2, ImmutableMap.of(KKResistanceType.lightning,20))),
        thundagaTrinket = ITEMS.register("thundaga_trinket", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.lightning,20))),
        thundagunTrinket = ITEMS.register("thundagun_trinket", () -> new KKArmorItem(new Item.Properties().stacksTo(1),3, ImmutableMap.of(KKResistanceType.lightning,25))),
